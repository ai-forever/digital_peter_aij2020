...
```
  ...
  987_65_14.jpg
```
точно находятся 5 идущих подряд строк. Этот 

Все строки написаны рукой Петра Великого в период с 1709 по 1713 годы (есть строки, написанные в 1704, 1707 и 1708 годах, но их не более 150; эти строки попали как в [train](https://storage.yandexcloud.net/datasouls-ods/materials/46b7bb85/datasets.zip), так и в test).
