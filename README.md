...
Внутри находятся 2 папки:  images и words. В папке images лежат .jpg файлы с вырезанными строками из документов Петра Великого, в папке words - .txt их транскрибированные версии (маппинг по названию).

Например, 

оригинал (1_1_10.jpg):
<p align="center">
  <img src="pics/1_1_10.png" width="70%">
</p>
